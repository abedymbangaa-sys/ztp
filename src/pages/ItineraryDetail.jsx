  ...
  "5-days-in-zanzibar": [
    {
      ...
      title: "Stone Town",
      area: "Stone Town",
      activities: "Old Fort, Forodhani Gardens, heritage walk through the winding alleys",
      links: [
    ...
    {
      day: 2,
      title: "Spice and culture",
      area: "Central Zanzibar",
      activities: "Spice farm tour, Kidichi Persian baths, Jozani Forest",
      links: [
        { label: "Nature & Jozani Forest", to: "/nature" },
    ...
    },
    {
      day: 3,
      title: "South coast",
      area: "Paje, Jambiani, Bwejuu",
      activities: "Beach time, sea caves, sunset on the south coast",
      links: [
    ...
    },
    {
      day: 4,
      title: "Marine day",
      area: "Mnemba / Safari Blue",
      activities: "Snorkelling, sandbank stop, dhow cruise",
      links: [
        { label: "Tours", to: "/tours" },
    ...
    },
    {
      day: 5,
      title: "North coast",
      area: "Nungwi, Kendwa, Matemwe",
      activities: "Beach, turtle aquarium, sunset before departure",
      links: [
        { label: "Hotels", to: "/hotels" },
        { label: "Beaches", to: "/beaches" },
      ],
